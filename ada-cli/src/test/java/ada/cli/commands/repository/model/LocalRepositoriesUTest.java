...
public class LocalRepositoriesUTest {
    ...
    public void test() throws IOException {
        ...
        LocalRepositories repositories = LocalRepositories
            .apply()
            .withRepository(r);

        String json = om.writeValueAsString(repositories);
        assertThat(om.readValue(json, LocalRepositories.class)).isEqualTo(repositories);
    }
