...
import ada.domain.legacy.repository.fs.FileSystemRepositorySink;
import ada.domain.legacy.repository.fs.FileSystemRepositorySinkMemento;
import ada.domain.legacy.repository.watcher.WatcherSink;
