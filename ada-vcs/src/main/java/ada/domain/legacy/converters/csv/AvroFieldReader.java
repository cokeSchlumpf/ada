package ada.domain.legacy.converters.csv;

import ada.commons.util.Either;
import ada.domain.legacy.datatypes.DataTypeDetector;
import ada.domain.legacy.datatypes.DataTypeMatcher;
import ada.domain.legacy.datatypes.Field;
