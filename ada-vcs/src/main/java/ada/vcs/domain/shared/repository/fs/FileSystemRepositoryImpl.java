package ada.vcs.domain.shared.repository.fs;

import ada.commons.util.Operators;
import ada.commons.util.ResourceName;
import ada.vcs.domain.shared.repository.api.RefSpec;
import ada.vcs.domain.shared.repository.api.RepositoryDirectAccess;
import ada.vcs.domain.shared.repository.api.User;
import ada.vcs.domain.shared.repository.api.exceptions.TagAlreadyExistsException;
import ada.vcs.domain.shared.repository.api.exceptions.TagReferenceNotFoundException;
import ada.vcs.domain.shared.repository.api.exceptions.VersionAlreadyExistsException;
import ada.vcs.domain.shared.repository.api.exceptions.VersionReferenceNotFoundException;
