...
import ada.vcs.domain.shared.repository.fs.FileSystemRepositorySettingsMemento;
import ada.vcs.domain.shared.repository.fs.FileSystemRepositorySink;
import ada.vcs.domain.shared.repository.fs.FileSystemRepositorySinkMemento;
import ada.vcs.domain.shared.repository.watcher.WatcherSink;
import ada.vcs.domain.shared.repository.watcher.WatcherSinkMemento;
